...
#let all-wvf = orientations.map(deg => (theta-deg: deg) + wvf-stencil(deg * 1deg))
#let all-lf = orientations.map(deg => (theta-deg: deg) + lf-stencil(deg * 1deg))
