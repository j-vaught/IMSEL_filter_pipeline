...
#figure(
  image("../figures/fig_sg_1d.pdf", width: 80%),
...
#figure(
  image("../figures/fig_sg_2d.pdf", width: 65%),
  caption: [Two-dimensional Savitzky--Golay filtering on a rectangular grid. A $5 times 5$ rectangular window is centered on the target pixel, and the fitted polynomial surface provides gradient estimates $partial f \/ partial x$ and $partial f \/ partial y$ at the center.],
) <fig:sg-2d>
...
#figure(
  image("../figures/fig_loess.pdf", width: 70%),
...
#figure(
  image("../figures/fig_wvf.pdf", width: 75%),
...
#figure(
  image("../figures/fig_lf.pdf", width: 75%),
...
#figure(
  image("../figures/fig_steerable.pdf", width: 85%),
...
#figure(
  image("../figures/fig_oriented_energy.pdf", width: 70%),
...
#figure(
  image("../figures/fig_aniso_gaussian.pdf", width: 75%),
...
#figure(
  image("../figures/fig_discrete_sweep.pdf", width: 70%),
...
#figure(
  image("../figures/fig_roberts.pdf", width: 55%),
...
#figure(
  image("../figures/fig_sobel.pdf", width: 80%),
...
#figure(
  image("../figures/fig_freichen.pdf", width: 75%),
...
#figure(
  image("../figures/fig_gaussian_deriv.pdf", width: 85%),
...
#figure(
  image("../figures/fig_canny_pipeline.pdf", width: 90%),
...
#figure(
  image("../figures/fig_hed.pdf", width: 80%),
...
#figure(
  image("../figures/fig_pidinet.pdf", width: 70%),
...
#figure(
  image("../figures/fig_gather_dot.pdf", width: 90%),
