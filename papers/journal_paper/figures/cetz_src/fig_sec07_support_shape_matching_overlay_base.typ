...
#import "../../colors.typ": garnet, atlantic, congaree, horseshoe, honeycomb, black90, black70, black30
...
#let render(data-path) = {
  ...
  cetz.canvas({
    ...
    content(
      (ox + pw / 2, oy + ph + 0.95),
      text(fill: black90, size: 10pt, weight: "bold")[#title],
    )
    content(
      (ox + pw / 2, oy + ph + 0.48),
      text(fill: black70, size: 8.4pt)[#subtitle],
    )
    ...
    content(
      ...
      text(fill: black90, size: 8pt, weight: "bold")[Anisotropy ratio],
    )
