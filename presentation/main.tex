...
\begin{frame}{Cross-Dataset Comparison: Optimized vs. Published}
  \begin{columns}[T]
...
\begin{frame}{Optimal Parameter Configurations by Dataset}
  \begin{table}
    \centering
...
\begin{frame}{Post-Processing Effects: NMS Hurts}
  \begin{columns}[T]
    \begin{column}{0.38\textwidth}
...
\begin{frame}{Classical Top 15 Ranking on BIPED v1}
  \centering
  \begin{tabular}{llr}
    \toprule
...
\begin{frame}{Deep Learning Comparison on Clean Data}
  \begin{columns}[T]
    \begin{column}{0.38\textwidth}
...
\begin{frame}{Cross-Dataset Noise Consistency}
  \begin{columns}[T]
    \begin{column}{0.38\textwidth}
...
\begin{frame}{ODS Gaps: Optimized vs. Bagan Parameters}
  \begin{columns}[T]
    \begin{column}{0.38\textwidth}
...
\begin{frame}{WVF vs. LF: Statistically Indistinguishable}
  \begin{table}
    \centering
...
\begin{frame}{Median ODS by Parameter Level}
  \centering
...
\begin{frame}{Crossover Heatmap: WVF vs. DL by Noise Type}
  \begin{columns}[T]
    \begin{column}{0.38\textwidth}
...
\begin{frame}{Summary of Statistical Evidence}
  \begin{table}
    \centering
...
\begin{frame}{Reconciling Bagan's Parameters}
...
\begin{frame}{The BSDS500 Outlier Problem}
...
\begin{frame}{WVF's Unique Position in the Landscape}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
...
\begin{frame}{Choosing Between WVF and Deep Learning}
  \begin{table}
    \centering
